                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <p>
                                <span><a class="compare text-dark" href="{{ route('book-read', ['id' => $book->id]) }}" title="{{ trans('client.read_now') }}"><i class="bi bi-book " ></i></a></span>
                                <span class="ml-3"><a title="{{ trans('client.detail') }}" class="compare" href="{{ route('book-detail', ['id' => $book->id]) }}"><i class="bi bi-search text-dark"></i></a></span>
